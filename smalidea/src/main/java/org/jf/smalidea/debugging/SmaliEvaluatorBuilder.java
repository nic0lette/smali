...
import org.jf.smalidea.debugging.expression.ArrayAccessEvaluator;
import org.jf.smalidea.debugging.expression.ArrayInitializerEvaluator;
import org.jf.smalidea.debugging.expression.BinaryExpressionEvaluator;
import org.jf.smalidea.debugging.expression.ConditionalExpressionEvaluator;
import org.jf.smalidea.debugging.expression.InstanceofEvaluator;
import org.jf.smalidea.debugging.expression.LiteralEvaluator;
import org.jf.smalidea.debugging.expression.LocalVariableEvaluator;
import org.jf.smalidea.debugging.expression.NewArrayInstanceEvaluator;
import org.jf.smalidea.debugging.expression.NewClassInstanceEvaluator;
import org.jf.smalidea.debugging.expression.UnaryExpressionEvaluator;
...
/*
 * This class is copied wholesale (with minor tweaks) from
 * java/debugger/impl/src/com/intellij/debugger/engine/evaluation/expression/EvaluatorBuilderImpl.java
 * at revision fa7bc38a0f74aa21adac990f5ec3dab9b59ece43 (Dec-9 2011)
 */
public class SmaliEvaluatorBuilder implements EvaluatorBuilder {
    private static final SmaliEvaluatorBuilder ourInstance = new SmaliEvaluatorBuilder();

    private SmaliEvaluatorBuilder() {
    }
        ...
        public void visitReferenceExpression(PsiReferenceExpression expression) {
            ...
            if (element instanceof PsiLocalVariable || element instanceof PsiParameter) {
                ...
                if (getContextPsiClass() == null || getContextPsiClass().equals(variableClass)) {
                    final LocalVariableEvaluator localVarEvaluator = new LocalVariableEvaluator(localName);
                ...
                if(qualifier != null) {
                    ...
                    myResult = new LocalVariableEvaluator(name);
                }
            }
        }
